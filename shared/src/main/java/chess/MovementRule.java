...
public static class BishopMovement extends BaseMovement {
    @Override
...
public static class KingMovement extends BaseMovement {
    @Override
    public Collection<ChessMove> moves(ChessBoard board, ChessPosition myPosition) {
        var moves = new HashSet<ChessMove>();
...
public static class QueenMovement extends BaseMovement {
    @Override
    public Collection<ChessMove> moves(ChessBoard board, ChessPosition myPosition) {
        var moves = new HashSet<ChessMove>();
...
public static class RookMovement extends BaseMovement {
    @Override
    public Collection<ChessMove> moves(ChessBoard board, ChessPosition myPosition) {
        var moves = new HashSet<ChessMove>();
        calculateMoves(board, myPosition,  0,  1, moves, true);
...
public static class PawnMovement extends BaseMovement {
    @Override
    public Collection<ChessMove> moves(ChessBoard board, ChessPosition myPosition) {
        var moves = new HashSet<ChessMove>();
        calculateMoves(board, myPosition,  1,  0, moves, false);
